...
namespace NewIIDIprogram.Controllers
{
    public class MasterStepsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MasterStepId,StepTitle")] MasterStep masterStep)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MasterStepId,StepTitle")] MasterStep masterStep)
        {
            if (ModelState.IsValid)
            {
